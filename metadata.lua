...
--- Plugin homepage
PLUGIN.homepage = "https://github.com/ahai-code/vfox-kubectl"
--- Plugin license, please choose a correct license according to your needs.
PLUGIN.license = "Apache 2.0"
--- Plugin description
PLUGIN.description = "Kubectl plugin"
...
NOTE:
 ...
 --]]
PLUGIN.manifestUrl = "https://github.com/ahai-code/vfox-kubectl/releases/download/manifest/manifest.json"
